...
if __name__ == '__main__':
    ...
    # model = gensim.models.Word2Vec.load_word2vec_format("C:\Pycharm\Projects\Glove\w2v.vectors.txt", binary=False)
    print 'model loaded'
    seed_file = codecs.open("C:\Pycharm\Projects\Kernel\seed_sim.txt", 'r', 'utf-8')
    ...
    output_file=codecs.open('C:\Users\Peng\Desktop\paper\SVR_1_0.3.text','w','utf-8')
